...
function displayResults($results)
{
    ...
    {?>
        <tr>
           ...
           <td style="width: 15%;"><center><strong><?php echo $print->FireOccurrences; ?></strong></center></td>
...
if ($search_query != '')
{
    $count = $wpdb->get_var("SELECT COUNT(*) FROM `wpstg0_ba_fireactivity` WHERE Postcode like '$search_query' and FireOccurrences > 0;");
    ...
    else
    {
        ...
        $results = $wpdb->get_results("SELECT * FROM `wpstg0_ba_fireactivity` WHERE Postcode like '$search_query' and FireOccurrences > 0;");
...
else
{
    ...
    $results = $wpdb->get_results("SELECT * FROM `wpstg0_ba_fireactivity`
LIMIT 7;");
